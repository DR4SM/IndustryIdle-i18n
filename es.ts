export const ES = {
    ...
    TranslatorName:
        "Juan Manuel Jaén Cabrera (Leunal17), Dishito, Daniel Padilla Rodríguez (danpad01), robertomd, MrGat0s, Daniel (DR4SM)",
    Language: "Idioma",
    ...
    PlayerTradeTaxCreditMarketCapDesc:
        "Este crédito fiscal es %{percentage} de su capitalización bursátil, puede mejorarse a través de Swiss Upgrade/Boost. El crédito total asciende al %{total} y has usado %{used}",
    PlayerTradeGrossTradeValue: "Valor comercial bruto",
    PlayerTradeTaxableValue: "Valor imponible",
    PlayerTradeTaxRate: "Valoración de impuestos",
    PlayerTradeTaxRateDesc:
        "El tipo impositivo se basa en la diferencia de precio entre su precio local y este comercio - el tipo impositivo es progresivo. 0% ~ 50%: 0,5% por cada 1% de diferencia; 50% ~ 75%: 1% por cada 1% de diferencia; 75% ~ 100%: 2% por cada 1% de diferencia.",
    PlayerTradeTaxPayable: "impuestos pagables",
    PlayerTradeTradeValueAfterTax: "Modificar el valor después de impuestos",
    PlayerTradeShowTaxCalculation: "Mostrar la calculación de impuestos",
    PlayerTradeHideTaxCalculation: "Ocultar ma la calculación de impuestos",
    PlayerTradeMaxTaxCreditValue: "Selecciona la cantidad de cuotas para los impuestos de los créditos",
    WaterProductionx2: "Super bomba de agua",
    WaterProductionx2Desc: "Las bombas de agua producen el doble pero consumen el doble de energía",
    InputBufferTypeAuto: "Automático",
    InputBufferTypeStockpile: "Almacén",
    InputBuffer: "Buffer de entrada de recursos.",
    InputBufferDesc:
        "Los ciclos máximos de recurso de entrada a mantener en el almacén antes de que este edificio deje de transportar ese recurso. Auto significa utilizar la predicción para mantener un buffer mínimo que permita una producción continua. Almacenar significa transportar siempre recursos de entrada independientemente de la cantidad que haya en el almacén.",
    InputCapacityOverride: "Anulación de la capacidad de entrada",
    InputCapacityOverrideDesc: "Por cada ciclo de producción, se transporta %{percent} de los recuersos necesarios para la producción",
    PumpkinSpiceLatte: "Latte de calabaza y especias",
    PumpkinPie: "Pie de calabaza",
    QuantumComputerLab: "Laboratorio de Computadoras cuánticas",
    QuantumComputer: "Computadora cuántica",
    TVStudioPlus: "Estudio de televisión especializado",
};
